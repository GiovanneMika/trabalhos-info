...
public class TelaMovimento extends javax.swing.JFrame {
    ...
    MovimentoDAO pp = new MovimentoDAO();
    ...
    private boolean telaToProfessor() {
        ...
        try {
            SimpleDateFormat s = new SimpleDateFormat("dd/MM/yyyy");
            p.setDataMov(Calendar.getInstance());
            p.getDataMov().setTime(s.parse(tDatamov.getText()));
        } catch (ParseException e) {
            JOptionPane.showMessageDialog(this, "Erro de Data");
            return false;
        }
        p.setValor((Double) tValor.getValue());
    ...
    public void setProfessor(Movimento p) {
        this.p = p;
        pessoaToTela();
    }
