...
public class ContatoService {
    ...
    public void insere(Contato p) {
        try {
            URL url = new URL("http://localhost:8080/crud123/contato");
    ...
    public void atualiza(Contato p) {
        try {
            URL url = new URL("http://localhost:8080/crud123/contato/" + p.getId());
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
            connection.setDoOutput(true);
    ...
    public Contato localiza(int id) {
        ...
        try {
            URL url = new URL("http://localhost:8080/crud123/contato/" + id);
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
